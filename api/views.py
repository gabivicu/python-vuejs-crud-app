...
class ItemViewSet(viewsets.ModelViewSet):
    ...
    @extend_schema(
        ...
        description=(
            "Returns comprehensive statistics about items including "
            "counts by priority, category, and completion status."
        ),
    ...
    def stats(self, request):
        ...
        if cached_stats is None:
            ...
            for priority_code, priority_name in Item.PRIORITY_CHOICES:
                priority_stats[priority_code] = Item.objects.by_priority(
                    priority_code
                ).count()
            ...
            for category_code, category_name in Item.CATEGORY_CHOICES:
                category_stats[category_code] = Item.objects.by_category(
                    category_code
                ).count()
